      ...
      >
        ...
        <div className="p-3 border-b border-[rgba(79,89,102,0.08)]">
          ...
          <div className="relative">
            ...
            {/* Dropdown */}
            {showModelDropdown && (
              <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-[rgba(79,89,102,0.08)] rounded-xl shadow-xl z-50 py-1 animate-scaleIn overflow-hidden">
                {MODELS.map((model) => (
                  <button
                    key={model.id}
                    onClick={() => {
